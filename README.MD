...
| Path | Purpose |
|------|----------|
| `/data/test-data.js` | Centralized test data and scenarios. |
| `/tests/search.spec.js` | Test spec for the search functionallity. |
| `/page-objects/` | Page Objects for selectors and search related actions. |
